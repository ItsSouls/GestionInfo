...
const PiezasTaller = () => {
  ...
  useEffect(() => {
    const fetchMateriales = async () => {
      try {
        const response = await axios.get('https://gestioninfo.onrender.com/api/materiales');
  ...
  useEffect(() => {
    if (material) {
      const fetchPiezas = async () => {
        try {
          const response = await axios.get(`https://gestioninfo.onrender.com/api/piezas/${material}`);
  ...
  const handleInsertar = async () => {
    ...
    try {
      ...
      console.log('Piezas:', piezas.data);
  ...
  const handleActualizar = async () => {
    ...
    try {
      ...
      const response = await axios.put(`https://gestioninfo.onrender.com/api/actualizar/${selectedPieza._id}`, updatedPieza);
  ...
  const handleBorrar = async () => {
    ...
    try {
      ...
      const response = await axios.delete(`https://gestioninfo.onrender.com/api/borrar/${selectedPieza._id}`);
